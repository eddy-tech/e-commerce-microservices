...
public class OrderResource {
    ...
    public ResponseEntity<Integer> createOrder(@RequestBody @Valid OrderRequest request) {
        return new ResponseEntity<>(this.orderService.createOrder(request), CREATED);
    }
